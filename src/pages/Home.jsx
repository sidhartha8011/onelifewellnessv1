  ...
  return (
    <>
      ...
      <div ref={sectionRefs.about} className="olw-section">
        <div className="olw-home-manual-layout">
          <div className="olw-home-manual-section">
            ...
            {/* <p className="olw-home-manual-section-para">
              ...
              to transform everyday choices into powerful, lasting habits.
              Whether you’re seeking mental clarity, aiming for greater
              productivity, or aspiring to a more abundant lifestyle, we offer
              evidence-based strategies that help you thrive.
            </p> */}
          </div>
          <div className="olw-section-image-layout">
            <img src={welcomeOne} alt="Welcome One" className="olw-mannual-section-image" />
          </div>
        </div>
      </div>
      ...
      <div ref={sectionRefs.about} className="olw-section">
        <div className="olw-home-manual-layout">
        <div className="olw-section-image-layout">
            <img src={welcomeTwo} alt="Welcome One" className="olw-mannual-section-image" />
          </div>
          <div className="olw-home-manual-section">
      ...
      <div ref={sectionRefs.essence} className="olw-section">
        <div className="olw-section-content">
          <div className="olw-section-text">
            ...
            <ul className="essence-section-home-layout">
              ...
              <li>
                ...
                <p>No complicated jargon—
                just straightforward guidance you can apply in daily life.
                </p>
              </li>
      ...
      <div ref={sectionRefs.team} className="olw-section">
        <div className="olw-section-content">
          <div className="olw-meet-heart-layout">
            <h2>Meet the Hearts Behind Our Mission</h2>
            ...
            <FaQuoteLeft className="quote-icon" /> We do what we do because life is a gift—one that should be
              nurtured, protected, and celebrated. <FaQuoteRight className="quote-icon" />
            </blockquote>
          </div>
        </div>
      </div>
      ...
      <div className="olw-welcome-articles-section">
        ...
        <div className="olw-welcome-articles-list">
          <div className="olw-welcome-article-card">
            <h3 className="olw-welcome-article-heading">Mastering Stress: 5 Practical Techniques for Busy Schedules</h3>
            <button>Read more <FaArrowRightLong className="olw-welcome-article-icon" /></button>
            
          </div>
          <div className="olw-welcome-article-card">
            <h3 className="olw-welcome-article-heading">Heart Health Essentials: Keeping Your Family Safe & Active</h3>
            <button>Read more <FaArrowRightLong className="olw-welcome-article-icon" /></button>
              </div>
          <div className="olw-welcome-article-card">
