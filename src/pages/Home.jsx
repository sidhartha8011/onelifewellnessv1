      ...
      <div className="olw-home-page">
        ...
        <div className="olw-home-content-box ">
          <div className="olw-home-left">
            ...
            <h3 className="fadeInUp">A One-Stop Guide to Living Well—Body, Mind, and Spirit</h3>
        ...
        {/* Intro Sections */}
        <div className="olw-welcome-intro-sections  olw-welcome-button-nav"   ref={navSectionRef}>
          {/* Section 1 */}
          <div className="olw-welcome-intro-section olw-welcome-layout-image-left">
            <div className="olw-welcome-image-container">
              <img
                src={manual}
                alt="One Life Wellness: A Manual for Life"
                className="olw-welcome-section-image zoomIn "
              />
            </div>
            <div className="olw-welcome-content-container">
          ...
          {/* Section 2 */}
          <div className="olw-welcome-intro-section olw-welcome-layout-image-right">
            <div className="olw-welcome-image-container">
              <img
                src={purpose}
            ...
            <div className="olw-welcome-content-container">
              ...
              <div className="olw-welcome-essence-section">
                <h3>Essence</h3>
                <ul className="olw-welcome-essence-list">
                  <li>
                    <strong>Trust & Transparency:</strong> Every article is
                    carefully reviewed by experts, ensuring reliability and
                    accuracy.
                  </li>
                  <li>
                    <strong>Holistic Focus:</strong> We cover everything from
                    physical fitness to mental health, nutrition, and lifestyle
                    optimization.
                  </li>
                  <li>
                    <strong>Empowering Simplicity:</strong> No complicated
                    jargon—just straightforward guidance you can apply in daily
                    life.
                  </li>
                </ul>
              </div>
          ...
          <div className="olw-welcome-intro-section olw-welcome-layout-image-left">
            ...
            <div className="olw-welcome-content-container">
              <h2>Meet the Hearts Behind Our Mission: Who We Are & Why We Care</h2>
              <p>
              ...
              <blockquote className="olw-welcome-section-quote">
            ...
            <ul className="olw-welcome-triple-path-list">
              <li>
                ...
                <p>
                  ...
                  handle life’s demands. By nourishing inner harmony, you create
              ...
              <li>
                ...
                <h3>Prosperity</h3>
                <p>
                  Develop an abundant mindset, aligning physical health and
                  mental clarity to create a fulfilling, successful life—both
                  personally and professionally. True prosperity flows from
