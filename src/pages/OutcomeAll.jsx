  ...
  return (
    <div className="flex-col align-center bottom-100">
      <div className="olw-hwgt-title-section">
        ...
        Life can sometimes feel like a balancing act—juggling responsibilities, nurturing relationships, and striving for personal growth all at once. At <b>One Life Wellness,</b> we believe that authentic well-being isn’t just about avoiding stress or checking off tasks; it’s about consciously <b>shaping your life</b> so that inner tranquility, meaningful accomplishments, and a sense of fulfillment naturally align.
<br /><br />
Through our holistic approach, we guide you toward tangible results that reflect three core pillars: <b>Peace, Productivity,</b> and <b>Prosperity</b>. Each pillar is integral to a life brimming with purpose, connection, and growth. When these elements come together, you gain more than just a healthier body or a clearer mind—you discover a <b>life-affirming transformation</b>   that enriches every aspect of your journey.
        </p>
      </div>
        ...
        <section className="explore-further-section">
          <div className="explore-further-content">
            ...
            <p className="explore-further-text">
              We encourage you to discover more through our articles, discussions, and community insights, each designed to expand your understanding of these pillars. Wherever you are on your journey, know that new perspectives and gentle shifts can create a ripple effect of positive change in your day-to-day life.
            </p>
            <div className="cta-container">
              <p className="cta-text">Stay Informed – Sign up for updates to receive reflective prompts and research highlights that keep you motivated.</p>
              <button className="cta-button">Sign Up Now</button>
            </div>
            <blockquote className="explore-further-quote">
              “True transformation begins when knowledge meets the heart’s readiness to embrace calm, purpose, and the quiet bounty of life.”
            </blockquote>
          </div>
        </section>
        </div>
